 ...
 */
function storeone_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function storeone_sanitize_css( $css ) {
 ...
 */
function storeone_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function storeone_sanitize_email( $email, $setting ) {
 ...
 */
function storeone_sanitize_hex_color( $hex_color, $setting ) {
	// Sanitize $input as a hex value without the hash prefix.
 ...
 */
function storeone_sanitize_html( $html ) {
 ...
 */
function storeone_sanitize_image( $image, $setting ) {
 ...
 */
function storeone_sanitize_nohtml( $nohtml ) {
 ...
 */
function storeone_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function storeone_sanitize_number_range( $number, $setting ) {
 ...
 */
function storeone_sanitize_select( $input, $setting ) {
 ...
 */
function storeone_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


function storeone_sanitize_sortable($values){
	$output = array();
